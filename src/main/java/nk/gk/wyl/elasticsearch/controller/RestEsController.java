...
@RestController
@RequestMapping("rest/v1/es-api")
@Api(tags = "ES7.4.1通用服务接口")
public class RestEsController {
    ...
    public String saveOrUpdate(@PathVariable("index") String index,
        ...
        Map<String,Object> saveOrUpdate = ParamsUtil.checkMap(body,"saveOrUpdate");
        String uid = ParamsUtil.getUid(body);
        return api.saveOrUpdate(client,index,saveOrUpdate,uid);
    }
    ...
    public Map<String,Object> findDataById(@PathVariable("index") String index,
                                           @PathVariable("id") String id) throws Exception {
       return api.findDataById(client,index,id);
    }
    ...
    public boolean delete(@PathVariable("index") String index,
                          ...
                          @RequestParam(value = "uid",defaultValue = "09901") String uid) throws Exception {
        return  api.delete(client,index,id,uid);
    }
    ...
    public Map<String,Object> pageFull(@RequestBody Map<String,Object> body) throws Exception {
    ...
    public Map<String,Object> findIndexFiledList(@PathVariable("index") String index,
                                                       @RequestParam(value = "is_all",defaultValue = "true") boolean is_all) throws Exception {
        return EsDataUtil.getIndexFiledList(client,index,is_all);
    }
    ...
    public Map<String,Object> findIndexFiledList(
                                                       @RequestParam(value = "is_all",defaultValue = "true") boolean is_all) throws Exception {
        return EsDataUtil.getIndexFiledList(client,"",is_all);
    }
    ...
    public boolean deleteBatch(@PathVariable("index") String index,
                            @RequestBody Map<String,Object> body) throws Exception {
        List<String> ids = ParamsUtil.checkMapList(body,"ids");
        String uid = ParamsUtil.getUid(body);
        // 逻辑还是物理删除
        return  api.delete(client,index,ids,uid);
    }
